...
public class Chunk {
    ...
    public NativeQueue<int> sunBFS;
    public NativeQueue<LightRemovalNode> sunRBFS;
    ...
    public Chunk(GameObject gameObject) {
        ...
        sunBFS = new NativeQueue<int>(Allocator.Persistent);
        sunRBFS = new NativeQueue<LightRemovalNode>(Allocator.Persistent);
